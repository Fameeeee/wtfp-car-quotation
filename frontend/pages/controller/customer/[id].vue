  ...
  <div class="flex min-h-screen bg-[#ececec] w-full text-black ml-[80px]">
    ...
    <div class="content flex flex-col flex-1 min-h-0" style="padding: 20px;">
      ...
      <div class="bg-white p-5 rounded-lg shadow-md relative min-h-[300px] overflow-hidden flex-1"
        ...
        <div class="back mb-4">
          <button @click="goBack" class="w-24 h-10 bg-red-600 hover:bg-red-800 cursor-pointer text-white rounded-md mb-2" style="margin-bottom: 10px;">
            < กลับ </button>
        </div>
        ...
        <div class="customer-data h-[400px] overflow-y-auto">
          <table v-if="customerData && customerData.quotations.length" class="w-full border-collapse mt-2">
            <thead>
              <tr class="bg-gray-100 font-bold text-center">
                <th class="border text-center border-gray-300 p-2 w-[100px]">ID</th>
                <th class="border text-center border-gray-300 p-2 w-[220px]">วันที่</th>
                <th class="border text-center border-gray-300 p-2 w-[220px]">ใบเสนอราคา</th>
              </tr>
            </thead>
            <tbody>
