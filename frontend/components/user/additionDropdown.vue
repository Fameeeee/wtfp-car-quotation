<template>
  <div class="w-full border border-black rounded-md font-semibold">
    ...
    >
      ...
      >
        <path
          d="M10.2083 14.5833L17.4999 21.8749L24.7916 14.5833"
          stroke="black"
          stroke-width="1.5"
    ...
    <transition name="slide-fade">
      <div
        v-if="open"
        class="p-6 border-t border-black space-y-6 bg-white rounded-lg shadow-md"
      >
        <!-- CMI -->
        <div class="flex items-center justify-between text-lg font-medium text-gray-800">
          ...
          <div class="flex gap-4 w-2/3">
            <div
              class="cursor-pointer py-2 px-4 rounded-lg text-sm font-semibold"
              :class="
                additionCosts.cmi ? 'bg-[#980000] text-white' : 'border-2 border-gray-300'
              "
        ...
        <div class="flex items-center justify-between text-lg font-medium text-gray-800">
          ...
          <input
            type="number"
            v-model.number="additionCosts.fuelValue"
